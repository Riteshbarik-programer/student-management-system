...
@WebServlet("/ams.controller.UpdateTeacher")
public class UpdateTeacher extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(status>0)
			response.sendRedirect("editTeacherProfile.jsp?msg=Registration Succesful");
		else
			response.sendRedirect("editTeacherProfile.jsp?msg=Registration Failed");
