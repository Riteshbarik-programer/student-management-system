...
@WebServlet("/ams.controller.UpdateStudent")
public class UpdateStudent extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(status>0)
			response.sendRedirect("editStudentProfile.jsp?msg=Updated Succesful");
		else
			response.sendRedirect("editStudentProfile.jsp?msg=Updation Failed");
	}
