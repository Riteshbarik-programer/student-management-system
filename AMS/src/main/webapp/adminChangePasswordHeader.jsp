			  ...
			  <div class="fixed-header">
			      <!--logo-->
			       <div class="logo wow fadeInLeft animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInLeft;">
                      <a href="index.jsp" ><img alt="" src="images/mm.jpg" class="lo"></a>
				   </div>
					<!--//logo-->
							...
							<nav class="link-effect-4" id="link-effect-4">
                              <ul>
							    ...
							    <div class="ddown-content">
							      <a href="adminChangePassword.jsp" data-hover="Admin">Admin</a>
							      <a href="#" data-hover="Teacher">Teacher</a>
							      <a href="studentChangePassword.jsp" data-hover="student">Student</a>
							    </div>
							  </li>
