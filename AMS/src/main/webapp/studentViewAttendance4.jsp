...
<body>
    <link rel="stylesheet" href="http://yui.yahooapis.com/pure/0.6.0/pure-min.css">
     ...
     <%
         ...
         %>
    <form method="post" action="ams.controller.StudentAttendanceSubject"  class="pure-form">
...
<div class="aspNetHidden">
	...
	<option value="C">C</option>
            ...
            <div>
                ...
                <div>
    <table class="table table-bordered table-hover" cellspacing="0" rules="all" border="1" id="gvSubjects" style="width:50%;border-collapse:collapse;">
        <tr align="center">
            <th align="left" scope="col">Date</th><th scope="col">Attendence</th>
        </tr>
        <%
        	String emailid = (String)session.getAttribute("emailid");
                    Student s = StudentDao.getDetails(emailid);
                	
                	ArrayList<StudentAttendance> all = StudentAttendanceDao.fetchAttendanceSubject(s,emailid,subject);
        ...
        <tr align="center" style="color:Green;background-color:White;">
            <td align="left"><%=s1.getAttendancedate() %></td>
            <td align="center">
            <%
